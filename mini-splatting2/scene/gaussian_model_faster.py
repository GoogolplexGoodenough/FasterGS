...
try:
    from diff_gaussian_rasterization_faster import SparseGaussianAdam
except:
    pass
...
class GaussianModel:
    ...
    # def add_densification_stats_culling(self, grad, update_filter, factor):
    #     self.xyz_gradient_accum[update_filter] = (torch.norm(grad[update_filter,:2], dim=-1, keepdim=True)*factor[update_filter])
    #     self.denom[update_filter] += 1        
