...
from gaussian_renderer.render_faster import render_imp_faster
import sys
    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        while network_gui.conn != None:
            try:
                ...
                if custom_cam != None:
                    net_image = render_imp_faster(custom_cam, gaussians, pipe, background, scaling_modifer)["render"]
        ...
        render_pkg = render_imp_faster(viewpoint_cam, gaussians, pipe, background, xyz_grad=True)
        ...
        with torch.no_grad():
            ...
            # Log and save
            # training_report(tb_writer, iteration, Ll1, loss, l1_loss, iter_time, testing_iterations, scene, render_imp, (pipe, background))
