...
def render_set(model_path, name, iteration, views, gaussians, pipeline, background, args):
    ...
    for _ in range(n) :
        ...
        rendering = render_faster(views[0], gaussians, pipeline, background, args.mult)["render"]
    ...
    for idx, view in enumerate(tqdm(views, desc="Rendering progress")):
        ...
        for _ in range(n):
            rendering = render_faster(view, gaussians, pipeline, background, args.mult)["render"]
